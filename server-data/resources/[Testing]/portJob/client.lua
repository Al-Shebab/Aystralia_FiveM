...
function NewChoise()
    ...
    while true do 
        ...
        if distance <= 60 then 
            ...
            if distance <= 10 and IsControlJustPressed(0, 38) then
                RemoveBlip(blip)
                NewBlip()
                break
            end
...
Citizen.CreateThread(function()
    ...
    AddTextComponentString("Dockyard Job")
...
CreateThread(function()
	...
	AddTextEntry("press_attach_vehicle", "Press ~INPUT_PICKUP~ to lift the pallet")
