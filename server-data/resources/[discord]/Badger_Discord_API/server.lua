...
card = '{"type":"AdaptiveCard","$schema":"http://adaptivecards.io/schemas/adaptive-card.json","version":"1.2","body":[{"type":"Image","url":"' .. Config.Splash.Header_IMG .. '","horizontalAlignment":"Center"},{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Click to join the Aystralia Network","style":"destructive","iconUrl":"https://cdn.discordapp.com/attachments/791543288620384286/791547368587264000/ay.png","url":"https://discord.gg/hWN7zXtbQP"}]}],"style":"default","bleed":true,"height":"stretch","isVisible":true}]}'
