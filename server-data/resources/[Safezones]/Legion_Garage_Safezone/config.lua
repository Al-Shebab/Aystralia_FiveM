Config = {
    Greenzones = {
        ["legion_garage"] = {
            location = {x = 231.16, y = -790.82, z = 30.56},
            diameter = (10 * 3.14159), -- the maximum width of the sphere. this is also the width on ground level. Multiply this by 3.14159 to have a better looking sphere, It's not required to do that however.
            ...
            restrictions = {
                ...
                speedlimit  = 50, -- NOTE: Measurement is in MP/H. Change to a speed if enabled. Else change to nil to disable.
            },
            customrestrictions = {
