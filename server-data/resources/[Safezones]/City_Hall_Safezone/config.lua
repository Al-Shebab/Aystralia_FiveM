Config = {
    Greenzones = {
        ["city_hall"] = {
            location = {x = -539.84, y = -213.07, z = 37.64},
            diameter = (16 * 3.14159), -- the maximum width of the sphere. this is also the width on ground level. Multiply this by 3.14159 to have a better looking sphere, It's not required to do that however.
            ...
            color = {r = 0, g = 255, b = 0, a = 0}, -- The color of the zone's sphere (set a to equal 0 to be transparent).
            restrictions = {
