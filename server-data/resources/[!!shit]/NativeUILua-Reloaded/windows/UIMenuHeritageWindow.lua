...
---Index
---@param Mum numberUIMenu = setmetatable({}, UIMenu)
...
--    end
--    local _UIMenu = {
--        Logo = Sprite.New(TxtDictionary, TxtName, 0 + X, 0 + Y, 501, 107, Heading, R, G, B, A),
--        Banner = nil,
...
--        _UIMenu.Subtitle.Rectangle = UIResRectangle.New(0 + _UIMenu.Position.X, 107 + _UIMenu.Position.Y, 501, 37, 0, 0, 0, 255)
...
--    _UIMenu.Extra.Up = UIResRectangle.New(0 + _UIMenu.Position.X, 144 + 38 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 501, 18, 0, 0, 0, 200)
--    _UIMenu.Extra.Down = UIResRectangle.New(0 + _UIMenu.Position.X, 144 + 18 + 38 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 501, 18, 0, 0, 0, 200)
--
--    _UIMenu.Description.Bar = UIResRectangle.New(_UIMenu.Position.X, 123, 501, 4, 0, 0, 0, 255)
--    _UIMenu.Description.Rectangle = Sprite.New("commonmenu", "gradient_bgd", _UIMenu.Position.X, 127, 501, 30)
...
--        self.Logo:Size(501 + self.WidthOffset, 107)
--        self.Title:Position(((self.WidthOffset + 501) / 2) + self.Position.X, 20 + self.Position.Y)
--        if self.Subtitle.Rectangle ~= nil then
--            self.Subtitle.Rectangle:Size(501 + self.WidthOffset + 100, 37)
--            self.PageCounter.Text:Position(425 + self.Position.X + self.WidthOffset, 110 + self.Position.Y)
--        end
--        if self.Banner ~= nil then
--            self.Banner:Size(501 + self.WidthOffset, 107)
--        end
--    end
--end
--
...
--                Menu.Logo = Sprite
--                Menu.Logo:Size(501 + self.WidthOffset, 107)
...
--                Menu.Banner:Size(501 + self.WidthOffset, 107)
...
--
--    self.Description.Bar:Size(501 + self.WidthOffset, 4)
--    self.Description.Rectangle:Size(501 + self.WidthOffset, 30)
--
...
--            self.Subtitle.Rectangle:Size(501 + self.WidthOffset, self.Subtitle.ExtraY)
--        end
...
--    end
--
--    self.Background:Size(501 + self.WidthOffset, self:CalculateItemHeight() + WindowHeight + ((self.Subtitle.ExtraY > 0) and 0 or 37))
--
--    self.Extra.Up:Size(501 + self.WidthOffset, 18)
--    self.Extra.Down:Size(501 + self.WidthOffset, 18)
--
...
--        self.Description.Rectangle:Size(501 + self.WidthOffset, ((Linecount == 1) and 37 or ((Linecount + 1) * 22)))
--    end
--end
--
-----Visible
...
--        local Item = self.Items[i]
--        local Type, SubType = Item()
--        local Width, Height = 501 + self.WidthOffset, self:CalculateItemHeightOffset(Item)
--
...
--    end
--
--    if IsMouseInBounds(ExtraX, ExtraY, 501 + self.WidthOffset, 18) then
...
--                    end
--                    Citizen.Wait(175)
--                    while IsDisabledControlPressed(0, 24) and IsMouseInBounds(_ExtraX, _ExtraY, 501 + self.WidthOffset, 18) do
--                        if #self.Items > self.Pagination.Total + 1 then
--                            self:GoUpOverflow()
--                        else
--                            self:GoUp()
...
--    end
--
--    if IsMouseInBounds(ExtraX, ExtraY + 18, 501 + self.WidthOffset, 18) then
...
--                    end
--                    Citizen.Wait(175)
--                    while IsDisabledControlPressed(0, 24) and IsMouseInBounds(_ExtraX, _ExtraY + 18, 501 + self.WidthOffset, 18) do
--                        if #self.Items > self.Pagination.Total + 1 then
--                            self:GoDownOverflow()
--                        else
--                            self:GoDown()
