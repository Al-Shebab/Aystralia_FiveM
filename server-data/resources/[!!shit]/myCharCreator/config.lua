...
Translation = {
    ['en'] = {
        ...
        ['advanced_face'] = '~b~Advanced face options',
        ['male'] = 'male',
        ['female'] = 'female',
        ['sex'] = 'Sex',
        ['parents'] = 'Parents',
        ...
        ['similarity'] = 'Face weight',
        ['complexion'] = 'Skin weight',
        ['ageing'] = 'Ageing',
...
Cfg.PermissionsRequired = false -- are permissions required to use the command
Cfg.AdminGroup = 'superadmin'
...
Cfg.AdvancedFaceParts = {
    {label = 'Nose 1', type = 'nose_1'},
    {label = 'Nose 2', type = 'nose_2'},
    {label = 'Nose 3', type = 'nose_3'},
    {label = 'Nose 4', type = 'nose_4'},
    {label = 'Nose 5', type = 'nose_5'},
    {label = 'Nose 6', type = 'nose_6'},
    {label = 'Eyebrows 5', type = 'eyebrows_5'},
    {label = 'Eyebrows 6', type = 'eyebrows_6'},
    {label = 'Cheeks 1', type = 'cheeks_1'},
    {label = 'Cheeks 2', type = 'cheeks_2'},
    {label = 'Cheeks 3', type = 'cheeks_3'},
    {label = 'Eye squint', type = 'eye_squint'},
    {label = 'Lip thickness', type = 'lip_thickness'},
    {label = 'Jaw 1', type = 'jaw_1'},
    {label = 'Jaw 2', type = 'jaw_2'},
    {label = 'Chin 1', type = 'chin_1'},
    {label = 'Chin 2', type = 'chin_2'},
    {label = 'Chin 3', type = 'chin_3'},
    {label = 'Neck thickness', type = 'neck_thickness'},
