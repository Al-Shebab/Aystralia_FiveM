...
Citizen.CreateThread(function()
     for k in pairs(position) do
        ...
        AddTextComponentString("Parachute")
...
RMenu.Add('parachute', 'main', RageUI.CreateMenu("Parachute", "Activate Parachute"))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('parachute', 'main'), true, true, true, function()

            RageUI.Button("Parachute", "Jump with parachute", {RightLabel = "~r~1000$"}, true, function(Hovered, Active, Selected)
                if (Selected) then   
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            for k in pairs(position) do
                ...
                if dist <= 1.0 then
                    ESX.ShowHelpNotification("Press ~INPUT_PICKUP~ to ~b~parachute")
