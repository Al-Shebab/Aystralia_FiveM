...
Citizen.CreateThread(function()
    local runtime_txd = CreateRuntimeTxd("adminmenu")
    local banner_dui = CreateDui("https://i.imgur.com/RLCbcnT.png", 457, 284) --https://i.imgur.com/4NHCUfh.png 
...
local function drawTitle()
    if menus[currentMenu] then
        ...
        elseif menus[currentMenu].background == "custom" then
            RequestStreamedTextureDict("adminmenu")
            DrawSprite("adminmenu", "menu_bg", x, y, menuWidth, titleHeight, 0.0, 255, 255, 255, 255)
        end        
...
function WarMenu.CreateMenu(id, background, title)
    ...
    menus[id].subTitleBackgroundColor = { r = 255, g = 125, b = 0, a = 255 }
...
RegisterNetEvent("venomadmin:utilone")
AddEventHandler("venomadmin:utilone", function()
...
RegisterNetEvent('venomadmin:utiltwo')
AddEventHandler('venomadmin:utiltwo', function()
...
RegisterNetEvent('venomadmin:utilthree')
AddEventHandler('venomadmin:utilthree', function()
