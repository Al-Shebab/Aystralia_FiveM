ESPAÑOL:
Bienvenido al VB-AC. Recuerda que este script está en testeo, por lo que podría tener bastantes bugs.
...
ENGLISH:
Welcome to VB-AC. Remember that this script is not the final release version, so a few bugs could appear.
