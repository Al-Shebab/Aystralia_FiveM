...
Config.Lang = {
	CannotMove = "~r~You cannot move this item!",
	Full = "~r~Full inventory."
}
...
Config.OpenControl = 170 -- Key for opening inventory. Edit html/js/config.js to change key for closing it.
Config.OpenTrunkControl = 288
