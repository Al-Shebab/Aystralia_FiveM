--================================================================================================
--==                      AYBanking BY VISIBAIT (BASED OFF NEW_BANKING)                        ==
--================================================================================================
  ...
  while true do
    ...
    if nearBankorATM() then
      ...
      if IsControlJustPressed(1, 38) then
        ...
        TriggerServerEvent('AYBanking:server:balance', inMenu)
      end
...
RegisterNetEvent('AYBanking:client:refreshbalance')
AddEventHandler('AYBanking:client:refreshbalance', function(balance)
  ...
  ESX.TriggerServerCallback('AYBanking:server:GetPlayerName', function(playerName)
    SendNUIMessage({
      type = "balanceHUD",
      balance = balance,
      player = playerName,
...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('AYBanking:server:depositvb', tonumber(data.amount), inMenu)
	TriggerServerEvent('AYBanking:server:balance', inMenu)
end)

RegisterNUICallback('withdraw', function(data)
	TriggerServerEvent('AYBanking:server:withdrawvb', tonumber(data.amountw), inMenu)
	TriggerServerEvent('AYBanking:server:balance', inMenu)
end)
...
RegisterNUICallback('transfer', function(data)
	TriggerServerEvent('AYBanking:server:transfervb', data.to, data.amountt, inMenu)
	TriggerServerEvent('AYBanking:server:balance', inMenu)
end)

RegisterNetEvent('AYBanking:result')
AddEventHandler('AYBanking:result', function(type, message)
