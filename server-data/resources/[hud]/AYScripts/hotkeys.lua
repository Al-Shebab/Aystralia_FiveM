...
cfg = {}
vRPhk = {}
Tunnel.bindInterface("ELRPScripts",vRPhk)
vRPserver = Tunnel.getInterface("vRP","ELRPScripts")
HKserver = Tunnel.getInterface("ELRPScripts","ELRPScripts")
...
cfg.hotkeys = {
  [344] = {
    -- F11 toggle Cuff nearest player
    group = 1, 
	pressed = function() 
