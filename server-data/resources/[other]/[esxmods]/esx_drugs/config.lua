...
Config.ProcessZones = {
	...
	SpiceProcessing = {coords = vector3(90.51, -1984.37, 20.74)--[[, name = _U('blip_spiceprocessing'), color = 30, sprite = 501, radius = 100.0]]},
}

Config.DealerCoords = {

	DrugDealer = {coords = vector3(759.1, 1295.72, 360.8), name = _U('blip_drugdealer'), color = 6, sprite = 378, radius = 50.0},
}

Config.RollJointCoords = {

	RollJoint = { coords = vector3( 381.888, -815.974, 29.304 ) },
}