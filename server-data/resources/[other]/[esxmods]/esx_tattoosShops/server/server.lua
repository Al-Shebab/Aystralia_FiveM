...
RegisterServerEvent("tattoos:Getplayerstattoos_s")
AddEventHandler("tattoos:Getplayerstattoos_s", function()
	...
	MySQL.Async.fetchAll("SELECT * FROM playerstattoos WHERE identifier = @identifier", {['@identifier'] = playerId}, function(result)
		if(result[1] ~= nil) then
			...
			TriggerClientEvent("tattoos:getplayerstattoos", _source, tattoosList)
		else
			...
			TriggerClientEvent("tattoos:getplayerstattoos", _source, {})
		end
	end)
