...
Config.Zones = {
  ...
  Cloakroom = {
	...
	hint = 'Press ~INPUT_CONTEXT~ to access cloakroom',
  },
  ...
  VehicleSpawner = {
	...
	hint = 'Press ~INPUT_CONTEXT~ to access garage',
  },
  ...
  VehicleDeleter = {
	...
	BlipColor = 5,
	BlipName = Config.nameJobLabel.." : garage",
	hint = 'Press ~INPUT_CONTEXT~ to store vehicle in garage',
  },
  ...
  Vente = {
	...
	ItemDrop = 100,
	ItemPrice  = 50,
	hint = 'Press ~INPUT_CONTEXT~ to pay the bill',
  },
