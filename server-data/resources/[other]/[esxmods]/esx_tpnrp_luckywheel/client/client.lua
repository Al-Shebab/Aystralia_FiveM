...
Citizen.CreateThread(function()
    ...
    if ESX.IsPlayerLoaded() then
        ...
        local carmodel = GetHashKey('ldsv')
        ...
        Citizen.CreateThread(function()
            ...
            local vehicle = CreateVehicle(carmodel, 963.79, 47.62, 75.0, 0.0, false, false)
...
Citizen.CreateThread(function()
	while true do
        ...
        if(GetDistanceBetweenCoords(coords, _wheelPos.x, _wheelPos.y, _wheelPos.z, true) < 1.5) and not _isRolling then
            ESX.ShowHelpNotification("Press E to use Lucky Wheel [10k per spin]")
