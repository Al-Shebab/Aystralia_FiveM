...
Config.NPCShop	          = { x = 90.01, y = -1966.52, z = 20.18, h = 46.0 } -- Location of the shop For the npc.
...
Config.Zones = {
    ...
    Shop = {coords = vector3(90.01, -1966.52, 20.18), name = _U('map_blip_shop'), color = 50, sprite = 120, radius = 25.0, Pos = { x = -55.42, y = 6392.8, z = 30.5}, Size  = { x = 3.0, y = 3.0, z = 1.0 }, },
}
