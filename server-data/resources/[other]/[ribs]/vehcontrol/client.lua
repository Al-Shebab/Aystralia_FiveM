...
Citizen.CreateThread(function()
    while true do
		...
		if IsPedInAnyVehicle(PlayerPedId(), false) then
			if ( IsControlJustReleased( 0, 178 ) or IsDisabledControlJustReleased( 0, 178 ) ) and GetLastInputMethod( 0 ) then -- Key to open NUI https://docs.fivem.net/docs/game-references/controls/
				openVehControl()
			end
		end
