Locales['en'] = {
  ...
  ['depop_vehicle']           = 'return display vehicle',
  ['return_provider']         = 'return vehicle to provider',
  ['get_rented_vehicles']     = 'DEALER plates out',
  ...
  ['pop_vehicle']             = 'put vehicle on display',
  ['display_cleared']         = 'put vehicles away',
  ['vehicle_displayed']       = 'you put vehicle on display',
  ...
  ['set_vehicle_owner_rent']  = 'Give DEALER plate to player',
  ['set_vehicle_owner_sell']  = 'sell vehicle to player',
  ['set_vehicle_owner_sell_society']  = 'assign Vehicle [Sale] [Society]',
  ['shop_menu']               = 'Press ~INPUT_CONTEXT~ to open ~b~dealership menu',
  ['generic_shopitem']        = '$%s',
