...
function UIMenuItem.New(Text, Description, _)
    ...
    _UIMenuItem = {
        ...
        Text = UIResText.New(tostring(Text) or "", 8, 0, 0.25, 245, 245, 245, 255, 0),
        ...
        Label = {
            Text = UIResText.New("", 0, 0, 0.23, 245, 245, 245, 255, 0, "Right"),
...
function UIMenuListItem.New(Text, Items, Index, Description,price)
    ...
    local _UIMenuListItem = {
        Base = UIMenuItem.New(Text or "", Description or ""),
        Items = Items,
        LeftArrow = Sprite.New("commonmenu", "arrowleft", 110, 105, 20, 20),
        RightArrow = Sprite.New("commonmenu", "arrowright", 280, 105, 20, 20),
        ItemText = UIResText.New("", 290, 104, 0.23, 255, 255, 255, 255, 0, "Right"),
        Label = {
...
function UIMenuListItem:Draw()
    ...
    local Offset = MeasureStringWidth(Text, 0, 0.23)
...
function UIMenuHorizontalOneLineGridPanel.New(LeftText, RightText)
    _UIMenuHorizontalOneLineGridPanel = {
        ...
        ParentItem = nil,
        Text = {
            Left = UIResText.New(LeftText or "Left", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
            Right = UIResText.New(RightText or "Right", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
        },
    }
...
function UIMenuStatisticsPanel:AddStatistics(Name)
    local Items = {
        Text = UIResText.New(Name or "", 0, 0, 0.23, 255, 255, 255, 255, 0, "Left"),
...
function UIMenuGridPanel.New(TopText, LeftText, RightText, BottomText)
    _UIMenuGridPanel = {
        ...
        ParentItem = nil,
        Text = {
            Top = UIResText.New(TopText or "Top", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
            Left = UIResText.New(LeftText or "Left", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
            Right = UIResText.New(RightText or "Right", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
            Bottom = UIResText.New(BottomText or "Bottom", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
        },
    }
...
_UIMenuColourPanel = {
    ...
    Text = UIResText.New(Title.." (1 sur "..#Colours..")" or "Title".." (1 sur "..#Colours..")", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
    ParentItem = nil,
}
...
function UIMenuPercentagePanel.New(MinText, MaxText)
    ...
    _UIMenuPercentagePanel = {
        ...
        Text = {
            Min = UIResText.New(MinText or "0%", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
            Max = UIResText.New("100%", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
            Title = UIResText.New(MaxText or "Opacity", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
        },
        Audio = {Slider = "CONTINUOUS_SLIDER", Library = "HUD_FRONTEND_DEFAULT_SOUNDSET", Id = nil},
        ParentItem = nil,
    }
   ...
   -- print(mouse)
    ...
    if Txt ~= "no" then 
        _UIMenu = {
            ...
            Banner = nil,
            Title = UIResText.New(Title, 215 + X, 20 + Y,0.90, 255, 255, 255, 255, 1, 1),
            Subtitle = {ExtraY = 0},
            WidthOffset = 0,
            Position = {X = X, Y = Y},
            ...
            Settings = {
                ...
                Audio = {
                    Library = "HUD_FRONTEND_CLOTHESSHOP_SOUNDSET",
                    UpDown = "NAV_UP_DOWN",
    ...
    if Subtitle ~= "" and Subtitle ~= nil then
        ...
        _UIMenu.Subtitle.Text = UIResText.New(Subtitle, 8 + _UIMenu.Position.X, 115 + _UIMenu.Position.Y, 0.23, 245, 245, 245, 255, 0)
        ...
        _UIMenu.PageCounter.Text = UIResText.New("eee", 425 + _UIMenu.Position.X, 115 + _UIMenu.Position.Y, 0.23, 245, 245, 245, 255, 0, "Right")
    ...
    _UIMenu.Description.Text = UIResText.New("Description", _UIMenu.Position.X + 5, 125, 0.23)
...
function UIMenu:MultilineFormat(str)
    if tostring(str) then
        ...
        for i = 1, #words do
            local offset = MeasureStringWidth(words[i], 0, 0.23)
...
function UIProgressBarItem.New(Text, X, Y, Heading, R, G, B, A)
    ...
    local _UIProgressBarItem = {
        ...
        Text = UIResText.New(Text or "N/A", 0, 0, 0.23, 255, 255, 255, 255, 0, "Centre"),
