...
ip = GetConvar('es_couchdb_url', 'game-db-fr-1.iceline.host') 	                    -- Change to wherever your DB is hosted, use convar
port = GetConvar('es_couchdb_port', '3306') 	                    -- Change to whatever port you have CouchDB running on, use convar
auth = GetConvar('es_couchdb_password', 'wcQs@PrzGe6NstWB=un+3vK+') 	            -- "user:password", if you have auth setup, use convar
