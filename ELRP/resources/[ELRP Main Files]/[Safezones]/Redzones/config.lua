Config = {
    Greenzones = {
        ["hospital"] = {
            location = {x = 324.47, y = -597.51, z = 46.08},
            diameter = (14 * 3.14159), -- the maximum width of the sphere. this is also the width on ground level. Multiply this by 3.14159 to have a better looking sphere, It's not required to do that however.
            ...
            restrictions = {
                ...
                speedlimit  = 50.0, -- NOTE: Measurement is in MP/H. Change to a speed if enabled. Else change to nil to disable.
            },
            customrestrictions = {
