Config = {
    Greenzones = {
        ["prison"] = {
            location = {x = 1738.46, y = 2604.60, z = 46.67},
            diameter = (40 * 3.14159), -- the maximum width of the sphere. this is also the width on ground level. Multiply this by 3.14159 to have a better looking sphere, It's not required to do that however.
            ...
            restrictions = {
                ...
                speedlimit  = 120.0, -- NOTE: Measurement is in MP/H. Change to a speed if enabled. Else change to nil to disable.
            },
            customrestrictions = {
