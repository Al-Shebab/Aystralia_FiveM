Config = {
    Greenzones = {
        ["city_speed_limit"] = {
            ...
            diameter = (96 * 3.14159), -- the maximum width of the sphere. this is also the width on ground level. Multiply this by 3.14159 to have a better looking sphere, It's not required to do that however.
            ...
            color = {r = 255, g = 0, b = 0, a = 0}, -- The color of the zone's sphere (set a to equal 0 to be transparent).
            restrictions = {
                blockattack = false, -- disables any type of attack and weapon usage.
                speedlimit  = 120, -- NOTE: Measurement is in MP/H. Change to a speed if enabled. Else change to nil to disable.
            },
            customrestrictions = {
