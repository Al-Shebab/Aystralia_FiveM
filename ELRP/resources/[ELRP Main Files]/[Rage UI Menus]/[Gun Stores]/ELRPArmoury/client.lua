RMenu.Add('vrpgunshops', 'main', RageUI.CreateMenu("", "~b~Ammunition", nil, nil, "largearms", "largearms"))
RMenu.Add('vrpgunshops', 'knifes', RageUI.CreateSubMenu(RMenu:Get('vrpgunshops', 'main'), "", "~b~Knifes", nil, nil, "largearms", "largearms"))
RMenu.Add('vrpgunshops', 'pistols', RageUI.CreateSubMenu(RMenu:Get('vrpgunshops', 'main'), "", "~b~Pistols", nil, nil, "largearms", "largearms"))
RMenu.Add('vrpgunshops', 'smgs', RageUI.CreateSubMenu(RMenu:Get('vrpgunshops', 'main'), "", "~b~Submachine Guns", nil, nil, "largearms", "largearms"))
RMenu.Add('vrpgunshops', 'shotgun', RageUI.CreateSubMenu(RMenu:Get('vrpgunshops', 'main'), "", "~b~Shotguns", nil, nil, "largearms", "largearms"))
RMenu.Add('vrpgunshops', 'ars', RageUI.CreateSubMenu(RMenu:Get('vrpgunshops', 'main'), "", "~b~Assault Rifles", nil, nil, "largearms", "largearms"))
RMenu.Add('vrpgunshops', 'sniper', RageUI.CreateSubMenu(RMenu:Get('vrpgunshops', 'main'), "", "~b~Sniper Rifles", nil, nil, "largearms", "largearms"))
RMenu.Add('vrpgunshops', 'throw', RageUI.CreateSubMenu(RMenu:Get('vrpgunshops', 'main'), "", "~b~Throwables", nil, nil, "largearms", "largearms"))
